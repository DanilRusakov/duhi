        ...
        <div >
            <?php if (!$cart_empty) { ?>
                ...
                <div class="simplecheckout-button-block buttons" id="buttons">
                    <div class="buyer-box">
                        ...
                        <?php } ?>
                        <?php if ($steps_count > 1) { ?>
                            <a class="button btn-primary button_oc btn" data-onclick="nextStep" id="simplecheckout_button_next" href="#"><span><?php echo $button_next; ?></span></a>
                        <?php } ?>
                        <!-- <div class="frm-row-submit"> -->
                            
                            <input type="submit" <?php echo $block_order ? 'disabled' : '' ?> data-onclick="createOrder" id="simplecheckout_button_confirm"  value="<? echo $button_order; ?>"></a>
                       <!--  </div> -->
            ...
            <?php } else { ?>
                ...
                <div class="simplecheckout-button-block buttons">
                    <div class="simplecheckout-button-right right"><a href="<? echo HTTP_SERVER; ?><?php echo $continue; ?>" class="button btn-primary button_oc btn"><span><?php echo $button_continue; ?></span></a></div>
                </div>
            <?php } ?>
        </div>
    </div>
