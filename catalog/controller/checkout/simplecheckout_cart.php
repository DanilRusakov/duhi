    ...
    public function index() {
        ...
        foreach ($products as $product) {
            ...
            if ($product['original_price'] > $product['price']) {
                $difference = $this->simplecheckout->formatCurrency($this->tax->calculate((($product['original_price']-$product['price'])*$product['quantity']), $product['tax_class_id'], $this->config->get('config_tax')));
                $percent = round(100-(($product['price']*100)/$product['original_price']));
            }
